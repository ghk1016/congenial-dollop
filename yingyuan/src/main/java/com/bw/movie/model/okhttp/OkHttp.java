...
public class OkHttp {
    ...
    //附近 影院
    public void doNear(final BackNear backNear){
        Observable<NearCinema> nearBean = okHttp.api.nearBean(13565, "157068736071213565", 1, 10, "116.30551391385724", "40.04571807462411");
    ...
    public void doSchdu(final Callschdu callschdu){
        Observable<SchduBean> schdu = okHttp.api.schdu("http://172.17.8.100/movieApi/tool/v2/findDateList");
        schdu.observeOn(AndroidSchedulers.mainThread()).subscribeOn(AndroidSchedulers.mainThread())
